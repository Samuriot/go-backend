...
# Purpose
- To learn how to create an HTTP server using Go's standard library (net/http)
...
- This includes working on innately supporting several different databases, etc.
